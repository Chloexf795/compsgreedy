def min_pipes(n, ranges):
    ...
    while watered <= n:
        farthest = -1  # track the farthest we can reach
        
        # Find the interval that extends farthest to the right
        # among all intervals that cover the point 'watered'
...
if __name__ == "__main__":
    ...
    print("Test 1:", min_pipes(3, [0, 0, 0, 0]))  # Should be 4 (need all pipes)
    
    # Example 2: Overlapping coverage
    print("Test 2:", min_pipes(5, [1, 2, 1, 0, 2, 1])) # Should be 2
    
    # Example 3: Impossible case
    print("Test 3:", min_pipes(10, [1, 0, 1]))  # Gap in coverage
    
    # Example 4: Better test - pipes with good coverage
    print("Test 4:", min_pipes(5, [3, 0, 0, 0, 0, 3]))  # Should be 2